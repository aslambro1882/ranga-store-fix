...
const showProducts = products => {
  products.forEach(product => {
    ...
    // Creating card div and setting inner HTML
      ...
      <div id="card" class="card h-100 bg-light">
          ...
          <div class="card-body p-2">
              ...
              <div class="stars-outer">
                <div style="width:${starPercentageRounded}" id="stars-inner" class="stars-inner">
              </div>
...
const addToCart = price => {
  ...
  // counting and setting valu to UI
  count = count + 1;
  document.getElementById("total-Products").innerText = count;

  // function calling for updating price
  updatePrice("price", price);

  // function calling for updating tax
  updateTaxAndCharge();

  // function calling for updating total
  updateTotal();
};

// function for load api for showing details of products
...
// functions for display details and set all data in modal
...
// function for get respective price from cart
